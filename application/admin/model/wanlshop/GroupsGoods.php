...
class GroupsGoods extends Model
{
    use SoftDelete;
	
    // 表名
    protected $name = 'wanlshop_groups_goods';
	...
	{
	    return $this->belongsTo('app\admin\model\wanlshop\ShopSort', 'shop_category_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
