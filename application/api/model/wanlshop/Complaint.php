...
class Complaint extends Model
{
    ...
    {
        return $this->belongsTo('app\api\model\wanlshop\Goods', 'complaint_goods_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
	
	public function groups()
	{
	    return $this->belongsTo('app\api\model\wanlshop\groups\Goods', 'complaint_goods_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}


    public function shop()
    {
        return $this->belongsTo('app\api\model\wanlshop\Shop', 'complaint_shop_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
}
