...
class CouponReceive extends Model
{
	...
	{
	    return $this->belongsTo('app\api\model\wanlshop\Conpou', 'conpou_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
	
	public function order()
	{
	    return $this->belongsTo('app\api\model\wanlshop\Order', 'order_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
