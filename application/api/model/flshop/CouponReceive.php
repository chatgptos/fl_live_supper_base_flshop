...
class CouponReceive extends Model
{
	...
	{
	    return $this->belongsTo('app\api\model\flshop\Conpou', 'conpou_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
	
	public function order()
	{
	    return $this->belongsTo('app\api\model\flshop\Order', 'order_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
