...
class Goods extends Model
{
    ...
    // 表名
    protected $name = 'booth_groups_goods';
	...
	{	
		$comment = model('app\api\model\flbooth\GoodsComment');
		$where = [
			'goods_id' => $data['id'],
			'order_type' => 'groups'
		];
	...
	{	
		return model('app\api\model\flbooth\groups\Ladder')
	...
	{
	    return $this->belongsTo('app\api\model\flbooth\Brand', 'brand_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
	
	// 运费模板
	public function freight()
	{
	    return $this->belongsTo('app\api\model\flbooth\ShopFreight', 'freight_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
	
	// 运费模板
	public function freightdata()
	{
	    return $this->belongsTo('app\api\model\flbooth\ShopFreightData', 'freight_id', 'freight_id', [], 'LEFT')->setEagerlyType(0);
	}
	...
	{
	    return $this->belongsTo('app\api\model\flbooth\Category', 'category_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
	
	// 店铺类目
	public function shopsort()
	{
	    return $this->belongsTo('app\api\model\flbooth\ShopSort', 'shop_category_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
