...
class Complaint extends Model
{
    ...
    // 表名
    protected $name = 'booth_complaint';
    ...
    {
        return $this->belongsTo('app\api\model\flbooth\Goods', 'complaint_goods_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
	
	public function groups()
	{
	    return $this->belongsTo('app\api\model\flbooth\groups\Goods', 'complaint_goods_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}


    public function shop()
    {
        return $this->belongsTo('app\api\model\flbooth\Shop', 'complaint_shop_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
}
