...
class CouponReceive extends Model
{
    ...
    // 表名
    protected $name = 'booth_coupon_receive';
	...
	{
	    return $this->belongsTo('app\api\model\flbooth\Conpou', 'conpou_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
	
	public function order()
	{
	    return $this->belongsTo('app\api\model\flbooth\Order', 'order_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
