...
class Shop extends flshop
{
    ...
    public function _initialize()
    {
        ...
        $this->model = new \app\index\model\flshop\Shop;
        $this->view->assign("stateList", $this->model->getStateList());
        $this->view->assign("statusList", $this->model->getStatusList());
        
        $this->view->assign("typeList", $this->model->getTypeList());
        $tree = Tree::instance();
        $category = new \app\index\model\flshop\Category;// 类目
    ...
    {
        return $this->view->fetch('flshop/page/index');
    }
    ...
    {
		$this->view->assign("stateList", model('app\index\model\flshop\Brand')->getStateList());
        return $this->view->fetch('flshop/brand/index');
    }
    ...
    {
        return $this->view->fetch('flshop/shopsort/index');
    }
    ...
    public function service()
    {
        if ($this->request->isAjax()) {
            ...
            $where['status'] = 'normal';
            $total = model('app\index\model\flshop\ShopService')->where($where)->count();
            $list = model('app\index\model\flshop\ShopService')->where($where)->select();
