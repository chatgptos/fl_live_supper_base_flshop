...
class Order extends flshop
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\index\model\flshop\Order;
    ...
    public function detail($id = null, $order_no = null)
    {
        ...
        $row['address'] = model('app\index\model\flshop\OrderAddress')
    ...
    public function delivery($ids = null)
    {
        ...
        foreach ($row as $vo) {
            ...
            $vo['address'] = model('app\index\model\flshop\OrderAddress')
	...
	private function pushOrder($order_id = 0, $state = '已发货')
	{
		...
		$orderGoods = model('app\index\model\flshop\OrderGoods')
