...
class Brand extends Flshop
{
    ...
    /**
     * Brand模型对象
     * @var \app\index\model\flshop\Brand
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\index\model\flshop\Brand;
		$tree = Tree::instance();
		$tree->init(collection(model('app\index\model\flshop\Category')->where('type','goods')->order('weigh desc,id desc')->select())->toArray(), 'pid');
