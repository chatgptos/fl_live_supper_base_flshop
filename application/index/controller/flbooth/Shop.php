...
class Shop extends flbooth
{
    ...
    public function _initialize()
    {
        ...
        $this->model = new \app\index\model\flbooth\Shop;
        $this->view->assign("stateList", $this->model->getStateList());
        $this->view->assign("statusList", $this->model->getStatusList());
        
        $this->view->assign("typeList", $this->model->getTypeList());
        $tree = Tree::instance();
        $category = new \app\index\model\flbooth\Category;// 类目
    ...
    {
        return $this->view->fetch('flbooth/page/index');
    }
    ...
    {
		$this->view->assign("stateList", model('app\index\model\flbooth\Brand')->getStateList());
        return $this->view->fetch('flbooth/brand/index');
    }
    ...
    public function attachment()
    {
        ...
        return $this->view->fetch('flbooth/attachment/index');
    }
    ...
    {
        return $this->view->fetch('flbooth/shopsort/index');
    }
    ...
    public function service()
    {
        if ($this->request->isAjax()) {
            ...
            $where['status'] = 'normal';
            $total = model('app\index\model\flbooth\ShopService')->where($where)->count();
            $list = model('app\index\model\flbooth\ShopService')->where($where)->select();
