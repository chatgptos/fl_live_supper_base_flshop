 ...
 * @icon fa fa-circle-o
 */
class Brand extends flbooth
{
    protected $noNeedLogin = '';
    protected $noNeedRight = '*';
    /**
     * Brand模型对象
     * @var \app\index\model\flbooth\Brand
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\index\model\flbooth\Brand;
		$tree = Tree::instance();
		$tree->init(collection(model('app\index\model\flbooth\Category')->where('type','goods')->order('weigh desc,id desc')->select())->toArray(), 'pid');
