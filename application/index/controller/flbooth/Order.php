...
class Order extends flbooth
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\index\model\flbooth\Order;
    ...
    public function detail($id = null, $order_no = null)
    {
        ...
        $row['address'] = model('app\index\model\flbooth\OrderAddress')
    ...
    public function delivery($ids = null)
    {
        ...
        foreach ($row as $vo) {
            ...
            $vo['address'] = model('app\index\model\flbooth\OrderAddress')
	...
	private function pushOrder($order_id = 0, $state = '已发货')
	{
		...
		$orderGoods = model('app\index\model\flbooth\OrderGoods')
