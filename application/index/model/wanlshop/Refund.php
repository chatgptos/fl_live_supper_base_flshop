...
class Refund extends Model
{
    ...
    {
        return $this->belongsTo('app\index\model\wanlshop\groups\OrderGoods', 'goods_ids', 'id', [], 'LEFT')->setEagerlyType(0);
    }
	...
	{
	    return $this->belongsTo('app\index\model\wanlshop\groups\Order', 'order_id', 'id', [], 'LEFT')->setEagerlyType(0);
	}
