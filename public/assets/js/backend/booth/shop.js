define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'booth.shop/index' + location.search,
                    add_url: 'booth.shop/add',
                    edit_url: 'booth.shop/edit',
                    del_url: 'booth.shop/del',
                    multi_url: 'booth.shop/multi',
                    import_url: 'booth.shop/import',
                    table: 'booth_shop',
                }
            });
