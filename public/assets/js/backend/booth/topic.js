define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'booth.topic/index' + location.search,
                    add_url: 'booth.topic/add',
                    edit_url: 'booth.topic/edit',
                    del_url: 'booth.topic/del',
                    multi_url: 'booth.topic/multi',
                    import_url: 'booth.topic/import',
                    table: 'booth_topic',
                }
            });
