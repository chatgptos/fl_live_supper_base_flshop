define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'booth.exhibitor/index' + location.search,
                    add_url: 'booth.exhibitor/add',
                    edit_url: 'booth.exhibitor/edit',
                    del_url: 'booth.exhibitor/del',
                    multi_url: 'booth.exhibitor/multi',
                    import_url: 'booth.exhibitor/import',
                    table: 'booth_exhibitor',
                }
            });
