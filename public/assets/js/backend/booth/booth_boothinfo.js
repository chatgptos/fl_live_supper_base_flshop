define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'booth.booth_boothinfo/index' + location.search,
                    add_url: 'booth.booth_boothinfo/add',
                    edit_url: 'booth.booth_boothinfo/edit',
                    del_url: 'booth.booth_boothinfo/del',
                    multi_url: 'booth.booth_boothinfo/multi',
                    import_url: 'booth.booth_boothinfo/import',
                    table: 'booth',
                }
            });
