define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'vue'], function ($, undefined, Backend, Table, Form, Vue) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'flbooth/money/index' + location.search,
                    add_url: '',
                    edit_url: '',
                    del_url: 'flbooth/money/del',
                    multi_url: '',
                    import_url: 'flbooth/money/import',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate,buttons: [{name: 'detail',title: __('资金详情'),classname: 'btn btn-xs btn-info btn-dialog',icon: 'fa fa-eye',url: 'flbooth/money/detail'}],formatter: Table.api.formatter.operate}
                    ]
                ]
            });
            // 为表格绑定事件
