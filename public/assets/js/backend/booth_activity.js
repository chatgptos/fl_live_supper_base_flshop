define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'booth_activity/index' + location.search,
                    add_url: 'booth_activity/add',
                    edit_url: 'booth_activity/edit',
                    del_url: 'booth_activity/del',
                    multi_url: 'booth_activity/multi',
                    import_url: 'booth_activity/import',
